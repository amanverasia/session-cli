...
- **cdp.py**: WebSocket-based Chrome DevTools Protocol client, JavaScript evaluation in Session's renderer, message sending, request management
- **cli.py**: argparse-based CLI with JSON output option for all commands
